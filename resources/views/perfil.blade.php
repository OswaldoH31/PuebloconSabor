        ...
        <div class="containers">
            <div id="div1">
                <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                    ...
                    <span class="form-row">
                        <span class="input-data">
                            <input id="Correo_electronico" type="email" @error('Correo_electronico') is-invalid @enderror" name="email" value="{{ old('email') ?? $users->email }}" required autocomplete="Correo_electronico">
